...
<div class="container1">
	<div class="leftcontent">
		...
		<div class="stickyC" style="position: sticky; top: 100px; padding-bottom: 100px;">
			<ul style="font-size:13px; list-style-type: none; padding-left:0px;">
				...
				<br>
				<li class="side_liT" style="color: lightgreen;">My point
	...
	<div class="rightcontent">
		<div class="pointList">
			<c:if test="${ptCount == 0}">
				<p style="text-align: center;">보유한 포인트가 없습니다.</p>
			</c:if>
			...
			<table class="table table-hover" style="text-align: center;">
				...
				<tr>
					...
					<td>${row.detail}</td>
					<td>
						<fmt:formatNumber value="${row.pt_plus}" pattern="#,###"/>
					
					</td>
					<td>
						<fmt:formatNumber value="${row.pt_minus}" pattern="#,###"/>
					</td>
					<td>
						<fmt:formatNumber value="${row.pt_total}" pattern="#,###"/>
					</td>
					<td>${row.order_num}</td>
				</tr>
				</c:forEach>
